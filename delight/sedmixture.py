...
class SpectralTemplate:
    ...
    def __init__(self,
        ...
        self.fbinterps = {}
        sed_interp = interp1d(tabulatedWavelength, tabulatedSpectrum)
        ...
        for filt in photometricBands:
            ...
            self.fbinterps[filt.bandName] =\
                interp2d(self.redshiftGrid, self.dustGrid, fmodgrid.T)

    def photometricFlux(self, redshift, dust, bandName):
        return self.fbinterps[bandName](redshift, dust)
